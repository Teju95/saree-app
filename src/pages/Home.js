      ...
      <div className="container">
        <div className="row justify-content-center text-center cursor">
          ...
          <div className="col-md-3">
            ...
            <h5 className="card-title border border-1 py-3 border-dark">
              Silk
            </h5>
          </div>
          <div className="col-md-3">
      ...
      <div className="container">
        <div className="row justify-content-center text-center">
          <div className="col-md-3 mb-5">
            <img
              src={logo}
              className="crd-img border border-2 border-dark border-bottom-0"
              alt="..."
            />
            <p className="card-title border border-2 border-dark ">
